...
namespace ISRC.BLL
{
	...
	public partial class T_DeptIndex
	{
		...
		/// 是否存在该记录
		/// </summary>
		public bool Exists(string DeptID, string IndexID)
		{
			return dal.Exists(DeptID, IndexID);
		}
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(string DeptID, string IndexID)
		{
			
			return dal.Delete(DeptID, IndexID);
		}

		/// <summary>
		/// 得到一个对象实体
		/// </summary>
		public ISRC.Model.T_DeptIndex GetModel(string DeptID, string IndexID)
		{
			
			return dal.GetModel(DeptID, IndexID);
		}

		/// <summary>
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ISRC.Model.T_DeptIndex GetModelByCache(string DeptID, string IndexID)
		{
			
			string CacheKey = "T_DeptIndexModel-" + DeptID + IndexID;
			object objModel = Maticsoft.Common.DataCache.GetCache(CacheKey);
			if (objModel == null)
			{
				try
				{
					objModel = dal.GetModel(DeptID, IndexID);
					if (objModel != null)
					{
