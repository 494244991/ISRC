...
namespace ISRC.DAL
{
	...
	public partial class T_Region
	{
		...
		public bool Exists(string ID)
		{
			...
			strSql.Append("select count(1) from T_Region");
		...
		public ISRC.Model.T_Region GetModel(string ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Name from T_Region ");
			strSql.Append(" where ID=SQL2012ID ");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012ID", SqlDbType.VarChar,64)			};
			parameters[0].Value = ID;
		...
		/// 得到一个对象实体
		/// </summary>
		public ISRC.Model.T_Region DataRowToModel(DataRow row)
		{
			ISRC.Model.T_Region model=new ISRC.Model.T_Region();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_Region T ");
