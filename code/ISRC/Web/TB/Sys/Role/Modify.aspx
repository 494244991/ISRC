<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="ISRC.Web.Sys.Role.Modify" %>
                    ...
                    <Rows>
                        <f:FormRow>
                            <Items>
                                ...
                                <f:TextBox ID="roleid" Label="角色编号" Width="250px" LabelWidth="100px" Required="true" runat="server">
                                </f:TextBox>

                                <f:TextBox ID="txbRoleName" Label="角色名称" Width="250px" LabelWidth="100px" Required="true" runat="server">
                                </f:TextBox>
                            </Items>
                        </f:FormRow>
                        <f:FormRow>
                            <Items>
                                <%--未实现嵌套检测,存在坏数据--%>
                                <f:TriggerBox ID="tgbParentName" Label="父项角色名称" Width="250px" LabelWidth="100px" EnableEdit="false" EnablePostBack="false"
                                    TriggerIcon="Search" Required="false" runat="server">
                                </f:TriggerBox>
                                
                                <f:DropDownList ID="ddlState" Label="角色状态" Width="250px" LabelWidth="100px" AutoPostBack="false" runat="server">
                        ...
                        <f:FormRow>
                            <Items>
                                <f:TextBox ID="txbDefaultUrl" Label="默认首页地址" Width="350px" LabelWidth="100px" Required="true" runat="server">
                                </f:TextBox>
                            </Items>
                        </f:FormRow>
                        <f:FormRow>
