        ...
        <f:Panel ID="panelMain" ShowBorder="false" ShowHeader="false" Layout="Fit" runat="server">
            <Items>
                <f:Grid ID="gridRole" Title="角色信息表" PageSize="10" ShowBorder="false" AllowPaging="true" OnPageIndexChange="grid_PageIndexChange"
                    ...
                    <Columns>
                        <f:WindowField Width="60px" ColumnID="Modify" TextAlign="Center" WindowID="windowPop" HeaderText="编辑" Icon="Pencil"
                        ...
                        <f:WindowField Width="80px" ColumnID="AuthorizationEdit" TextAlign="Center" WindowID="windowPop" HeaderText="权限设置" Icon="CdEdit"
                        ...
                        <f:BoundField Width="100px" ColumnID="RoleName" SortField="RoleName" DataField="RoleName" DataFormatString="{0}"
