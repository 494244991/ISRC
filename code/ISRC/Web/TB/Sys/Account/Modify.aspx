<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="ISRC.Web.Sys.Account.Modify" %>
                        ...
                        <f:Tab ID="tab_01" Title="标签一" BodyPadding="5px" Layout="Fit" runat="server">
                            <Items>
                                <f:SimpleForm ID="simpleForm_01" ShowHeader="false" AutoScroll="true" ShowBorder="false" runat="server">
                                    <Items>
                                        <f:TextBox ID="txbAccountName" Label="用户名" Width="250px" LabelWidth="70px" Enabled="false" runat="server">
                                        </f:TextBox>
                                        <f:TextBox ID="txbPassword" Label="密码" Width="250px" LabelWidth="70px" Enabled="false" runat="server">
                                        </f:TextBox>
                                    </Items>
                                </f:SimpleForm>
                            </Items>
                        ...
                        <f:Tab ID="tab_02" Title="标签二" BodyPadding="5px" Layout="Fit" runat="server">
                            <Items>
                                <f:SimpleForm ID="simpleForm_02" ShowHeader="false" ShowBorder="false" runat="server">
                                    <Items>
                                        <f:TriggerBox ID="tgbRoleName" Label="角色名称" Width="250px" LabelWidth="70px" EnableEdit="false" TriggerIcon="Search" runat="server">
                                        </f:TriggerBox>
