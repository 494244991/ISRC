<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="ISRC.Web.Trigger.Index" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="panelMain" runat="server" ShowBorder="false" ShowHeader="false">
            <Items>
                <f:Grid ID="gridIndex" runat="server" Title="二级指标" ShowBorder="false" AllowPaging="true" ShowHeader="true" IsDatabasePaging="true"
                    ...
                    <Columns>
                        <f:BoundField Width="120px" ColumnID="ID" SortField="ID" DataField="ID" TextAlign="Center" HeaderText="子指标编号"></f:BoundField>
                        <f:BoundField Width="150px" ColumnID="Name" SortField="Name" DataField="Name" TextAlign="Center" HeaderText="子指标名称"></f:BoundField>
                        <f:BoundField Width="100px" ColumnID="Description" SortField="Description" DataField="Description" TextAlign="Center" HeaderText="描述"></f:BoundField>
                    </Columns>
                </f:Grid>
            </Items>
        </f:Panel>
