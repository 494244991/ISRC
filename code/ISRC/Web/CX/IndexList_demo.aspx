<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="IndexList_demo.aspx.cs" Inherits="ISRC.Web.CX.IndexList" %>
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        <f:DropDownList ID="ddlIndex" runat="server" Label="指标类型">
                            ...
                            <f:ListItem Text="财政科技投入金额（亿元）" Value="1" />
                            <f:ListItem Text="地方财政支出（亿元）" Value="2" />
                        </f:DropDownList>
                    </Items>
                </f:Toolbar>
                ...
                <f:Toolbar ID="Toolbar2" runat="server">
                    <Items>
                        ...
                        <f:DropDownList ID="startYear" runat="server" Label="起始时间" Width="180px" Hidden="true">
                            <f:ListItem Text="2016年" Value="2016" Selected="true" />
                            <f:ListItem Text="2015年" Value="2015" />
                            <f:ListItem Text="2014年" Value="2014" />
                            <f:ListItem Text="2013年" Value="2013" />
                            <f:ListItem Text="2012年" Value="2012" />
                        </f:DropDownList>
                        ...
                        <f:DropDownList ID="endYear" runat="server" Label="结束时间" Width="180px" Hidden="true">
                            <f:ListItem Text="2016年" Value="2016" Selected="true" />
                            <f:ListItem Text="2015年" Value="2015" />
                            <f:ListItem Text="2014年" Value="2014" />
                            <f:ListItem Text="2013年" Value="2013" />
                    ...
                    <div id="chartDiv" style="display:none;">
                        <div>
                            ...
                            <select id="chartOptions">
                                <option value="0" selected>柱状图</option>
