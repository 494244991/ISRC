...
namespace ISRC.DAL
{
	...
	public partial class T_IndexCategory
	{
		...
		public bool Exists(string ID)
		{
			...
			strSql.Append("select count(1) from T_IndexCategory");
		...
		/// 得到一个对象实体
		/// </summary>
		public ISRC.Model.T_IndexCategory DataRowToModel(DataRow row)
		{
			ISRC.Model.T_IndexCategory model=new ISRC.Model.T_IndexCategory();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Name,FatherID ");
			strSql.Append(" FROM T_IndexCategory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_IndexCategory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_IndexCategory";
